...
static DCCoreData* instance = nil;  
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"%@",FILENAME] withExtension:@"momd"];
